...
### can be outperformed. Here, simple augmentation on reads will be imposed.
...
def train(config = None, args = None, arch = None):
    ...
    for epoch in range(config.epochs):
        ...
        for i, (event, event_len, label, label_len) in enumerate(data_loader):
            ...
            if i % 20 == 0:
                ...
                event = spectogram.add_noise(event)
    ...
    metrics_csv = metrics.to_csv('results/metrics_csv/loss_aug.csv')
